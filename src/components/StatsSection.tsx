          ...
          >
            ...
            <div className="mt-8">
              ...
              <p className="text-muted-foreground text-lg leading-relaxed">
                Thousands of students worldwide trust DEVZeroOne to advance their careers. 
                Our proven track record speaks for itself - with industry-leading instructors, 
                comprehensive curricula, and a supportive community, we're here to help you succeed.
              </p>
            </div>
          </motion.div>
        </div>
